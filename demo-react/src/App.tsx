...
function App() {
    const [activeTab, setActiveTab] = useState<"dx" | "mui">("dx");
                    ...
                    {activeTab === "dx" && (
                        <>
                            ...
                            <Section title="Number Box">
                                ...
                                <Field
                                    label="5. Disable Arrows (Integer)"
                                    value={nb5}
                                >
                                    <CnxNumberBox
                                        disableArrow
